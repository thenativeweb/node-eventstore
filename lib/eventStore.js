...
Store.prototype.hasConfigurationErrors = function(callback) {
    var err;
            ...
            worker.process = setInterval(function() {
                ...
                (function next(e) {
                    ...
                    var process = function(event, next) {
                        ...
                        self.storage.setEventToDispatched(event);
...
Store.prototype.commitSnapshot = function(snapshot, cb) {
    
    if (this.hasConfigurationErrors(cb)) return;
            ...
            for (i = 0, len = events.length; i < len; i++) {
                ...
                async.waterfall([
                    ...
                    function(item, callback) {                        
                        ...
                        self.undispatchedEventsQueue.push(item);
                    }
                ]);
            }
