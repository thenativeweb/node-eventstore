...
//          enableDispatching: true // default is true [optional]
//      });
//      
...
Store = function(options) {
    ...
    this.options.enableDispatching = this.options.enableDispatching !== undefined ? this.options.enableDispatching : true;
...
Store.prototype = {
    ...
    start: function(callback) {
        ...
        if (!this.storage.isConnected && (typeof this.storage.connect === 'function')) {
            this.storage.connect(function(err) {
                ...
                if (self.options.enableDispatching) {
                    initDispatcher();
                } else {
                    if (callback) callback(null);
                }
            });
        } else if (this.options.enableDispatching) {
            initDispatcher();
        } else {
            if (callback) callback(null);
        }
    ...
    getNewEventStream: function(streamId) {
        return new EventStream(this, streamId, null);
    },
